...
**Inherits:**
Adminable, [ISablierV2](/src/interfaces/ISablierV2.sol/contract.ISablierV2.md)

_Abstract contract implementing common logic. Implements the ISablierV2 interface._
...
_Protocol revenues mapped by token addresses._
...
_Checks that `streamId` points to a stream that exists._
