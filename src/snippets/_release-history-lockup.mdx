...
| ------------------------------------------------ | ------------- | ---------------------------------------------------------------------- |
| [v4.0](/guides/lockup/deployments) (latest)      | March 2026    | `LK3` (Lockup)                                                         |
| [v3.0](/guides/lockup/previous-deployments/v3.0) | October 2025  | `LK2` (Lockup): all models have been merged into a single contract     |
