...
title: "V2.0 Deployments"
---

This list of addresses is for the older V2.0 contracts. For the latest version, see [here](/contracts/v2/deployments).
...
The difference between the latest version of the contracts and these ones can be found in the
