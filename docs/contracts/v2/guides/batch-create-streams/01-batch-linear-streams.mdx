...
- [`createWithDurationsLL`](/contracts/v2/reference/periphery/contract.SablierV2Batch#createwithdurationsll)
- [`createWithTimestampsLL`](/contracts/v2/reference/periphery/contract.SablierV2Batch#createwithtimestampsll)
...
[Batch.CreateWithDurationsLL](/contracts/v2/reference/periphery/types/library.Batch#createwithdurationsll) structs:

```solidity
// Declare the first stream in the batch
Batch.CreateWithDurationsLL memory stream0;
...
Batch.CreateWithDurationsLL memory stream1;
...
Batch.CreateWithDurationsLL[] memory batch = new Batch.CreateWithDurationsLL[](batchSize);
batch[0] = stream0;
batch[1] = stream1;
```
