...
[Merkle Factory](/contracts/v2/reference/periphery/contract.SablierV2MerkleLockupFactory).

This guide assumes that you have already gone through the [Protocol Concepts](/concepts/protocol/airstreams) section.
