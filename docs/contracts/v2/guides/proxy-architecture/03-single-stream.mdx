...
Then, if the allowance is less than the transferred amount, we have to also approve the Permit2 contract. To take
maximum advantage of Permit2, we should do a max approval:
