...
Lockup Linear stream programmatically.
...
is [`LockupLinear.CreateWithDurations`](/contracts/v2/reference/core/types/library.LockupLineam), and it can be
...
[this link](https://github.com/sablier-labs/examples/blob/main/v2/core/LinearStreamCreator.sol).

```solidity reference title="Lockup Linear Stream Creator"
https://github.com/sablier-labs/examples/blob/main/v2/core/LinearStreamCreator.sol
```
