...
## The complete dynamic stream creator contract
...
[this link](https://github.com/sablier-labs/examples/blob/main/v2/core/DynamicStreamCreator.sol).

```solidity reference title="Dynamic Stream Creator"
https://github.com/sablier-labs/examples/blob/main/v2/core/DynamicStreamCreator.sol
```
