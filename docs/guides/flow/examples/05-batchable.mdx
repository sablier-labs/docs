...
<CodeBlock language="solidity" metastring={`reference title=""`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/flow/FlowBatchable.sol#L1-L2`}
</CodeBlock>

Import the relevant symbols:

<CodeBlock language="solidity" metastring={`reference title=""`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/flow/FlowBatchable.sol#L4-L6`}
</CodeBlock>
...
<CodeBlock language="solidity" metastring={`reference title=""`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/flow/FlowBatchable.sol#L12-L14`}
</CodeBlock>
...
<CodeBlock language="solidity" metastring={`reference title=""`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/flow/FlowBatchable.sol#L67`}
</CodeBlock>
...
<CodeBlock language="solidity" metastring={`reference title=""`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/flow/FlowBatchable.sol#L68-L73`}
</CodeBlock>

Construct an array of `bytes` of length 2 to be passed into the `batch` function:

<CodeBlock language="solidity" metastring={`reference title=""`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/flow/FlowBatchable.sol#L75-L82`}
</CodeBlock>

Since we are creating two streams, the function will return an array containing the two generated stream IDs:

<CodeBlock language="solidity" metastring={`reference title=""`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/flow/FlowBatchable.sol#L84-L88`}
</CodeBlock>

Execute the `batch`:

<CodeBlock language="solidity" metastring={`reference title=""`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/flow/FlowBatchable.sol#L91`}
</CodeBlock>
...
<CodeBlock language="solidity" showLineNumbers metastring={`reference title="Flow Batchable"`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/flow/FlowBatchable.sol`}
</CodeBlock>
