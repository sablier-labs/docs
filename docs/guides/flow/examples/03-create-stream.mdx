...
Import the relevant symbols from
[`@sablier/flow`](http://localhost:3000/guides/flow/examples/local-environment#install-flow-npm-package), and the
[`FlowUtilities`](http://localhost:3000/guides/flow/examples/flow-calculate-rps) library:
