...
import DeploymentsV3_0 from "../../../src/autogen/airdrops/_table-deployments-v3.0.mdx";
...
This section contains the deployment addresses for the v3.0 release of [@sablier/airdrops][latest].
