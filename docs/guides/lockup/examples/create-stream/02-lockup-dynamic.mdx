...
[this link](https://github.com/sablier-labs/examples/blob/feat/flow/lockup/core/LockupDynamicStreamCreator.sol).

```solidity reference title="Lockup Dynamic Stream Creator"
https://github.com/sablier-labs/examples/blob/feat/flow/lockup/core/LockupDynamicStreamCreator.sol
```
