...
[this link](https://github.com/sablier-labs/examples/blob/feat/flow/lockup/core/LockupTranchedStreamCreator.sol).

```solidity reference title="Lockup Tranched Stream Creator"
https://github.com/sablier-labs/examples/blob/feat/flow/lockup/core/LockupTranchedStreamCreator.sol
```
