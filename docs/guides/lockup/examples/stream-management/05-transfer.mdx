...
[`withdrawMaxAndTransfer`](/reference/lockup/contracts/contract.SablierLockup#withdrawmaxandtransfer)
...
<CodeBlock
  language="solidity"
  showLineNumbers
  metastring={`reference title="Stream Management: Withdraw and Transfer Ownership"`}
>
...
<CodeBlock language="solidity" showLineNumbers metastring={`reference title="Stream Management: Transfer Ownership"`}>
