...
[this link](https://github.com/sablier-labs/examples/blob/feat/flow/lockup/periphery/AirstreamCreator.sol).

```solidity reference title="Airstream Creator"
https://github.com/sablier-labs/examples/blob/feat/flow/lockup/periphery/AirstreamCreator.sol
```
