...
[link](https://github.com/sablier-labs/examples/blob/feat/flow/lockup/periphery/BatchLLStreamCreator.sol).

```solidity reference title="Batch Lockup Linear stream creator"
https://github.com/sablier-labs/examples/blob/feat/flow/lockup/periphery/BatchLLStreamCreator.sol
```
