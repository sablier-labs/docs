...
[link](https://github.com/sablier-labs/examples/blob/feat/flow/lockup/periphery/BatchLTStreamCreator.sol).

```solidity reference title="Batch Lockup Tranched stream creator"
https://github.com/sablier-labs/examples/blob/feat/flow/lockup/periphery/BatchLTStreamCreator.sol
```
