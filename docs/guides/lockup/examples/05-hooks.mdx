...
<CodeBlock language="solidity" metastring={`reference title=""`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/lockup/RecipientHooks.sol#L22-L24`}
</CodeBlock>
...
<CodeBlock language="solidity" showLineNumbers metastring={`reference title="Sablier Lockup Recipient Hooks"`}>
  {`https://github.com/sablier-labs/evm-monorepo/blob/main/misc/examples/lockup/RecipientHooks.sol`}
</CodeBlock>
