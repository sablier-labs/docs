...
You must set the protocol admin to the Sablier controlled address 0xb1bEF51ebCA01EB12001a639bDBbFF6eEcA12B9F. Failure to
...
--private-key $PRIVATE_KEY \
--rpc-url $RPC_URL \
--sig "run(address)" 0xb1bEF51ebCA01EB12001a639bDBbFF6eEcA12B9F \
--verifier-url $VERIFIER_URL \
--verify \
-vvv
```
