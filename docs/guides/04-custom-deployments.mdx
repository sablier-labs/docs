...
- Follow the contributing guides for <Link href={`${Links.GitHub.AIRDROPS}/blob/main/CONTRIBUTING.md`}>Airdrops</Link>,
  <Link href={`${Links.GitHub.FLOW}/blob/main/CONTRIBUTING.md`}>Flow</Link> and
  <Link href={`${Links.GitHub.LOCKUP}/blob/main/CONTRIBUTING.md`}>Lockup</Link>.
...
[EVM Utils repo](https://github.com/sablier-labs/evm-utils/blob/v1.0.1/src/tests/ChainId.sol). Then, bump the EVM Utils
version in each protocol repository's `package.json` file (e.g.,
