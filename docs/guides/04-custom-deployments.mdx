...
#### Step 1: Clone the [Lockup repo](https://github.com/sablier-labs/lockup) and checkout to the `v3.0.0` tag
...
#### Step 1: Clone the [Merkle Airdrops repo](https://github.com/sablier-labs/airdrops) and checkout to `v2.0.0` tag
...
#### Step 1: Clone the [Flow repo](https://github.com/sablier-labs/flow) and checkout to `v2.0.0` tag
