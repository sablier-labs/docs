...
import DeploymentsV4_0 from "../../../src/autogen/lockup/_table-deployments-v4.0.mdx";
...
This section contains the deployment addresses for the v4.0 release of [@sablier/lockup][latest].
