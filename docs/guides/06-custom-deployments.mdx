...
#### Step 1: Clone the <Link href={Links.GitHub.MONOREPO}>evm-monorepo</Link> and checkout to the `utils@v2.0` tag
...
#### Step 1: Clone the <Link href={Links.GitHub.MONOREPO}>evm-monorepo</Link> and checkout to the `lockup@v4.0` tag
...
#### Step 1: Clone the <Link href={Links.GitHub.MONOREPO}>evm-monorepo</Link> and checkout to the `airdrops@v3.0` tag
...
#### Step 1: Clone the <Link href={Links.GitHub.MONOREPO}>evm-monorepo</Link> and checkout to the `flow@v3.0` tag
