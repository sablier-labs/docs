...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/7cb361717fd2f0289ad8d69469a3c00804b21657/src/interfaces/ISablierMerkleLL.sol)
...
or [ClaimLLWithVesting](/docs/reference/airdrops/contracts/interfaces/interface.ISablierMerkleLL.md#claimllwithvesting)
event. Requirements:
...
- Refer to the requirements in
  [claim](/docs/reference/airdrops/contracts/interfaces/interface.ISablierMerkleLL.md#claim).
...
- See the example in the
  [claimViaSig](/docs/reference/airdrops/contracts/interfaces/interface.ISablierMerkleLL.md#claimviasig) function.
...
- Refer to the requirements in
  [claim](/docs/reference/airdrops/contracts/interfaces/interface.ISablierMerkleLL.md#claim). Below is the example of
