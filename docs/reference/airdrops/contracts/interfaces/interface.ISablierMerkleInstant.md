...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/7cb361717fd2f0289ad8d69469a3c00804b21657/src/interfaces/ISablierMerkleInstant.sol)
...
- Refer to the requirements in
  [claim](/docs/reference/airdrops/contracts/interfaces/interface.ISablierMerkleInstant.md#claim).
...
- See the example in the
  [claimViaSig](/docs/reference/airdrops/contracts/interfaces/interface.ISablierMerkleInstant.md#claimviasig) function.
...
- Refer to the requirements in
  [claim](/docs/reference/airdrops/contracts/interfaces/interface.ISablierMerkleInstant.md#claim). Below is the example
  of typed data to be signed by the airdrop recipient, referenced from
