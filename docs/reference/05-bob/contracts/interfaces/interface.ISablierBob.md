...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierBob.sol)

**Inherits:** IComptrollerable,
[ISablierBobState](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBobState.md)
...
Emits a [CreateVault](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#createvault) event. Notes:
...
Emits an [Enter](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#enter) event. Notes:
...
- See notes for [enter](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#enter). Requirements:
- See requirements for [enter](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#enter).
...
Emits a [Redeem](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#redeem) event. Notes:
...
Emits a [SetDefaultAdapter](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#setdefaultadapter)
event. Notes:
...
- If new adapter is not zero address, it must implement
  [ISablierBobAdapter](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBobAdapter.md) interface.
...
[SetNativeToken](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#setnativetoken) event.
Requirements:
...
Emits a [SyncPriceFromOracle](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#syncpricefromoracle)
event. Notes:
...
- Useful for syncing the price from oracle without calling
  [redeem](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#redeem) or
  [enter](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#enter). This function can be called by
...
Emits an [UnstakeFromAdapter](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBob.md#unstakefromadapter)
event. Requirements:
