...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/IBobVaultShare.sol)
...
- `vaultId` must be equal to the
  [VAULT_ID](/docs/reference/05-bob/contracts/interfaces/interface.IBobVaultShare.md#vault_id).
