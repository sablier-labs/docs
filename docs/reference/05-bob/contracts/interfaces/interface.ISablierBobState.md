...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierBobState.sol)

**Title:** ISablierBobState

Contract with state variables for the [SablierBob](/docs/reference/05-bob/contracts/contract.SablierBob.md) contract,
their respective getters and modifiers.
