...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierBobAdapter.sol)
...
Emits a [SetYieldFee](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBobAdapter.md#setyieldfee) event.
Notes:
...
Emits a [Stake](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBobAdapter.md#stake) event. Requirements:
...
Emits an
[UnstakeFullAmount](/docs/reference/05-bob/contracts/interfaces/interface.ISablierBobAdapter.md#unstakefullamount)
event. Notes:
