...
**Inherits:** [IComptrollerable](/docs/reference/05-bob/contracts/interfaces/interface.IComptrollerable.md)

**Title:** Comptrollerable

See the documentation in [IComptrollerable](/docs/reference/05-bob/contracts/interfaces/interface.IComptrollerable.md).
