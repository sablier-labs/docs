...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/d6f6f1d4bb0a5bf508c1d0d7c1b59cd8879d56f9/src/interfaces/ISablierEscrow.sol)
...
A peer-to-peer token swap protocol that allows users to swap ERC-20 tokens with each other.
...
Emits a [CancelOrder](/docs/reference/bob/contracts/interfaces/interface.ISablierEscrow.md#cancelorder) event.
Requirements:
...
Emits a [CreateOrder](/docs/reference/bob/contracts/interfaces/interface.ISablierEscrow.md#createorder) event.
Requirements:
...
Emits an [FillOrder](/docs/reference/bob/contracts/interfaces/interface.ISablierEscrow.md#fillorder) event.
Requirements:
...
[SetNativeToken](/docs/reference/bob/contracts/interfaces/interface.ISablierEscrow.md#setnativetoken) event.
Requirements:
...
Emits a [SetTradeFee](/docs/reference/bob/contracts/interfaces/interface.ISablierEscrow.md#settradefee) event.
Requirements:
...
Emitted when an order is cancelled by the seller.
...
Emitted when the trade fee is updated.
