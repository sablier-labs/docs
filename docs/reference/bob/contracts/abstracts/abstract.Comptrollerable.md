...
**Inherits:** [IComptrollerable](/docs/reference/bob/contracts/interfaces/interface.IComptrollerable.md)

**Title:** Comptrollerable

See the documentation in [IComptrollerable](/docs/reference/bob/contracts/interfaces/interface.IComptrollerable.md).
