...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierFactoryMerkleExecute.sol)
...
[ISablierMerkleExecute](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleExecute.md).
...
[SablierMerkleExecute](/docs/reference/03-airdrops/contracts/contract.SablierMerkleExecute.md) campaign will be
deployed.

Reverts if the requirements from
[createMerkleExecute](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierFactoryMerkleExecute.md#createmerkleexecute)
are not met.
...
| ----------------- | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `campaignParams`  | `MerkleExecute.ConstructorParams` | Struct encapsulating the [SablierMerkleExecute](/docs/reference/03-airdrops/contracts/contract.SablierMerkleExecute.md) parameters. |
...
Emitted when a [SablierMerkleExecute](/docs/reference/03-airdrops/contracts/contract.SablierMerkleExecute.md) campaign
is created.
