...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierFactoryMerkleInstant.sol)
...
[ISablierMerkleInstant](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleInstant.md).
...
[SablierMerkleInstant](/docs/reference/03-airdrops/contracts/contract.SablierMerkleInstant.md) campaign will be
deployed.

Reverts if the requirements from
[createMerkleInstant](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierFactoryMerkleInstant.md#createmerkleinstant)
are not met.
...
| ----------------- | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `campaignParams`  | `MerkleInstant.ConstructorParams` | Struct encapsulating the [SablierMerkleInstant](/docs/reference/03-airdrops/contracts/contract.SablierMerkleInstant.md) parameters. |
...
Emitted when a [SablierMerkleInstant](/docs/reference/03-airdrops/contracts/contract.SablierMerkleInstant.md) campaign
is created.
