...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierFactoryMerkleLT.sol)
...
[ISablierMerkleLT](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLT.md).
...
[SablierMerkleLT](/docs/reference/03-airdrops/contracts/contract.SablierMerkleLT.md) campaign will be deployed.

Reverts if the requirements from
[createMerkleLT](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierFactoryMerkleLT.md#createmerklelt)
are not met.
...
| Name              | Type                         | Description                                                                                                               |
| ----------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `campaignParams`  | `MerkleLT.ConstructorParams` | Struct encapsulating the [SablierMerkleLT](/docs/reference/03-airdrops/contracts/contract.SablierMerkleLT.md) parameters. |
...
Emitted when a [SablierMerkleLT](/docs/reference/03-airdrops/contracts/contract.SablierMerkleLT.md) campaign is created.
