...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierMerkleBase.sol)
...
Emits a [Clawback](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleBase.md#clawback) event.
Requirements:
...
Emits a
[LowerMinFeeUSD](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleBase.md#lowerminfeeusd) event.
Requirements:

- `msg.sender` must be the comptroller.
- The new fee must be less than the current
  [minFeeUSD](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleBase.md#minfeeusd).
...
Emits a [Sponsor](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleBase.md#sponsor) event.
Notes:
