...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierMerkleVCA.sol)

**Inherits:**
[ISablierMerkleSignature](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleSignature.md)
...
It emits a [ClaimVCA](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleVCA.md#claimvca) event,
and a
[RedistributeReward](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleVCA.md#redistributereward)
...
- See the example in the
  [claimViaSig](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleVCA.md#claimviasig) function.
...
- Refer to the requirements in
  [claimTo](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleVCA.md#claimto).
...
- Refer to the requirements in
  [claimTo](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleVCA.md#claimto) except that there
  are no restrictions on `msg.sender`. Below is the example of typed data to be signed by the airdrop recipient,
