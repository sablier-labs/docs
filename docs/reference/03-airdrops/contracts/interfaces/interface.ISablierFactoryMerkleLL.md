...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierFactoryMerkleLL.sol)
...
[ISablierMerkleLL](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLL.md).
...
[SablierMerkleLL](/docs/reference/03-airdrops/contracts/contract.SablierMerkleLL.md) campaign will be deployed.

Reverts if the requirements from
[createMerkleLL](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierFactoryMerkleLL.md#createmerklell)
are not met.
...
| ----------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `campaignParams`  | `MerkleLL.ConstructorParams` | Struct encapsulating the [SablierMerkleLL](/docs/reference/03-airdrops/contracts/contract.SablierMerkleLL.md) parameters. |
...
Emitted when a [SablierMerkleLL](/docs/reference/03-airdrops/contracts/contract.SablierMerkleLL.md) campaign is created.
