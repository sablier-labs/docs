...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierMerkleInstant.sol)
...
It emits a
[ClaimInstant](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleInstant.md#claiminstant) event.
Requirements:
...
- Refer to the requirements in
  [claim](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleInstant.md#claim).
...
- See the example in the
  [claimViaSig](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleInstant.md#claimviasig)
  function.
...
- Refer to the requirements in
  [claim](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleInstant.md#claim). Below is the
  example of typed data to be signed by the airdrop recipient, referenced from
