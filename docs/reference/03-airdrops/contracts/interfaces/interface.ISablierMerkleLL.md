...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierMerkleLL.sol)
...
It emits either
[ClaimLLWithTransfer](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLL.md#claimllwithtransfer)
or
[ClaimLLWithVesting](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLL.md#claimllwithvesting)
event. Requirements:
...
- Refer to the requirements in
  [claim](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLL.md#claim).
...
- See the example in the
  [claimViaSig](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLL.md#claimviasig) function.
...
- Refer to the requirements in
  [claim](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLL.md#claim). Below is the example of
