...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierMerkleLT.sol)

**Inherits:**
[ISablierMerkleLockup](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLockup.md),
...
It emits either
[ClaimLTWithTransfer](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLT.md#claimltwithtransfer)
or
[ClaimLTWithVesting](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLT.md#claimltwithvesting)
event. Requirements:
...
- Refer to the requirements in
  [claim](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLT.md#claim).
...
- See the example in the
  [claimViaSig](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLT.md#claimviasig) function.
...
- Refer to the requirements in
  [claim](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLT.md#claim). Below is the example of
