...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/SablierMerkleLT.sol)

**Inherits:** [ISablierMerkleLT](/docs/reference/03-airdrops/contracts/interfaces/interface.ISablierMerkleLT.md),
[SablierMerkleLockup](/docs/reference/03-airdrops/contracts/abstracts/abstract.SablierMerkleLockup.md),
[SablierMerkleSignature](/docs/reference/03-airdrops/contracts/abstracts/abstract.SablierMerkleSignature.md)
...
Calculates the vesting start time, and the tranches based on the claim amount and the unlock percentages for each
tranche.
