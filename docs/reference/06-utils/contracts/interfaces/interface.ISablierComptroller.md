...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierComptroller.sol)
...
1. [calculateMinFeeWeiFor](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#calculateminfeeweifor) -
   used by protocols inherited from **IComptrollerable**.
2. [convertUSDFeeToWei](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#convertusdfeetowei) -
   used by protocols inherited from **IComptrollerable**.
3. [execute](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#execute) - used by
   comptroller admin to perform necessary operations.
4. [getMinFeeUSDFor](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#getminfeeusdfor) -
   used by protocols inherited from **IComptrollerable**.
...
[convertUSDFeeToWei](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#convertusdfeetowei)
for more details.
...
Mainnet. Use
[calculateMinFeeWei](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#calculateminfeewei)
...
[calculateMinFeeWeiFor](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#calculateminfeeweifor)
to retrieve the fee in wei.
...
Emits an
[UpdateCustomFeeUSD](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#updatecustomfeeusd)
event. Notes:
...
Emits an [Execute](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#execute) event.
Requirements:
...
Emits a [SetAttestor](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#setattestor) event.
Notes:
...
- `customFeeUSD` must be less than or equal to
  [MAX_FEE_USD](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#max_fee_usd).
...
Emits a [SetMinFeeUSD](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#setminfeeusd)
event. Notes:
...
Emits a [SetOracle](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#setoracle) event.
Requirements:
...
Emits a [TransferFees](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#transferfees)
event. Notes:
...
Emits a
[WithdrawERC20Token](/docs/reference/06-utils/contracts/interfaces/interface.ISablierComptroller.md#withdrawerc20token)
event. Requirements:
