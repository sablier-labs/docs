...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierLockupDynamic.sol)
...
Emits a {Transfer},
[CreateLockupDynamicStream](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupDynamic.md#createlockupdynamicstream)
and {MetadataUpdate} event. Requirements:

- All requirements in
  [createWithTimestampsLD](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupDynamic.md#createwithtimestampsld)
