...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierLockupState.sol)

**Title:** ISablierLockupState

Contract with state variables (storage and constants) for the
[SablierLockup](/docs/reference/02-lockup/contracts/contract.SablierLockup.md) contract, their respective getters and
helpful modifiers.
