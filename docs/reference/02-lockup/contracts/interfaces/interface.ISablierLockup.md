...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierLockup.sol)

**Inherits:** IBatch, IComptrollerable, IERC4906, IERC721Metadata,
[ISablierLockupDynamic](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupDynamic.md),
[ISablierLockupLinear](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupLinear.md),
[ISablierLockupPriceGated](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupPriceGated.md),
[ISablierLockupTranched](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupTranched.md)
...
Emits an [AllowToHook](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#allowtohook) event.
Notes:
...
- `recipient` must implement
  [ISablierLockupRecipient](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupRecipient.md).
...
Emits a {Transfer},
[CancelLockupStream](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#cancellockupstream) and
...
[InvalidStreamInCancelMultiple](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#invalidstreamincancelmultiple)
event. Notes:
...
- Refer to the notes and requirements from
  [cancel](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#cancel).
...
Emits a
[RenounceLockupStream](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#renouncelockupstream)
event. Notes:
...
Emits a [SetNFTDescriptor](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#setnftdescriptor)
...
Emits a {Transfer},
[WithdrawFromLockupStream](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#withdrawfromlockupstream)
...
- Refer to the notes in [withdraw](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#withdraw).
  Requirements:
- Refer to the requirements in
  [withdraw](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#withdraw).
...
[InvalidWithdrawalInWithdrawMultiple](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#invalidwithdrawalinwithdrawmultiple)
event. Notes:

- This function as a whole will not revert if one or more withdrawals revert.
- This function attempts to call a hook on the recipient of each stream, unless `msg.sender` is the recipient.
- Refer to the notes and requirements from
  [withdraw](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockup.md#withdraw). Requirements:
- Must not be delegate called.
