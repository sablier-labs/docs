...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierBatchLockup.sol)
...
| `lockup`    | `ISablierLockup` | The address of the [SablierLockup](/docs/reference/02-lockup/contracts/contract.SablierLockup.md) contract used to create the streams. |
