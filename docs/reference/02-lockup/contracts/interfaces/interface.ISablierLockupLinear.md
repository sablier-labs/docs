...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierLockupLinear.sol)
...
Emits a {Transfer},
[CreateLockupLinearStream](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupLinear.md#createlockuplinearstream)
and {MetadataUpdate} event. Requirements:

- All requirements in
  [createWithTimestampsLL](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupLinear.md#createwithtimestampsll)
