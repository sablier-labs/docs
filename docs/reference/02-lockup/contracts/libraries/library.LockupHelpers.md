...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/libraries/LockupHelpers.sol)
...
[SablierLockup-\_createLD](/docs/reference/02-lockup/contracts/abstracts/abstract.SablierLockupDynamic.md#_createld)
function.
...
Checks the parameters of the
[SablierLockup-\_createLL](/docs/reference/02-lockup/contracts/abstracts/abstract.SablierLockupLinear.md#_createll)
function.
...
Checks the parameters of the
[SablierLockup-\_createLPG](/docs/reference/02-lockup/contracts/abstracts/abstract.SablierLockupPriceGated.md#_createlpg)
function.
...
Checks the parameters of the
[SablierLockup-\_createLT](/docs/reference/02-lockup/contracts/abstracts/abstract.SablierLockupTranched.md#_createlt)
function.
