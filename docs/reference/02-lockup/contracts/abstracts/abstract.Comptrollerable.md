...
**Inherits:** [IComptrollerable](/docs/reference/02-lockup/contracts/interfaces/interface.IComptrollerable.md)

**Title:** Comptrollerable

See the documentation in
[IComptrollerable](/docs/reference/02-lockup/contracts/interfaces/interface.IComptrollerable.md).
