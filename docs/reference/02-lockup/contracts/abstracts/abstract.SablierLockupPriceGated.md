...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/abstracts/SablierLockupPriceGated.sol)

**Inherits:**
[ISablierLockupPriceGated](/docs/reference/02-lockup/contracts/interfaces/interface.ISablierLockupPriceGated.md),
[NoDelegateCall](/docs/reference/02-lockup/contracts/abstracts/abstract.NoDelegateCall.md),
[SablierLockupState](/docs/reference/02-lockup/contracts/abstracts/abstract.SablierLockupState.md)
...
- The LPG model does not support a "createWithDuration" function because the
  [SablierLockup](/docs/reference/02-lockup/contracts/contract.SablierLockup.md) contract is at the size limit. If the
  EVM contract size limit is increased in the future, this function will be added. Requirements:
