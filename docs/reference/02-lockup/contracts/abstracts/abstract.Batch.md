...
**Inherits:** [IBatch](/docs/reference/02-lockup/contracts/interfaces/interface.IBatch.md)

**Title:** Batch

See the documentation in [IBatch](/docs/reference/02-lockup/contracts/interfaces/interface.IBatch.md).
