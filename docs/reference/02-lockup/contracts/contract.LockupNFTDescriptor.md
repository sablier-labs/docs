...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/LockupNFTDescriptor.sol)

**Inherits:** [ILockupNFTDescriptor](/docs/reference/02-lockup/contracts/interfaces/interface.ILockupNFTDescriptor.md)

**Title:** LockupNFTDescriptor

See the documentation in
[ILockupNFTDescriptor](/docs/reference/02-lockup/contracts/interfaces/interface.ILockupNFTDescriptor.md).
