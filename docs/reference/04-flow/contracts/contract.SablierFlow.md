...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/SablierFlow.sol)

**Inherits:** [Batch](/docs/reference/04-flow/contracts/abstracts/abstract.Batch.md),
[Comptrollerable](/docs/reference/04-flow/contracts/abstracts/abstract.Comptrollerable.md), ERC721,
[ISablierFlow](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md),
[NoDelegateCall](/docs/reference/04-flow/contracts/abstracts/abstract.NoDelegateCall.md),
[SablierFlowState](/docs/reference/04-flow/contracts/abstracts/abstract.SablierFlowState.md)

**Title:** SablierFlow

See the documentation in [ISablierFlow](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md).
...
constructor(
    ...
    [Comptrollerable](/docs/reference/04-flow/contracts/abstracts/abstract.Comptrollerable.md)(initialComptroller)
