...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierFlowState.sol)

**Title:** ISablierFlowState

Contract with state variables (storage and constants) for the
[SablierFlow](/docs/reference/04-flow/contracts/contract.SablierFlow.md) contract, their respective getters and helpful
modifiers.
