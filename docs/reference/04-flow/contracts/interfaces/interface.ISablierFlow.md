...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/interfaces/ISablierFlow.sol)

**Inherits:** IBatch, IComptrollerable, IERC4906, IERC721Metadata,
[ISablierFlowState](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlowState.md)
...
Emits a [AdjustFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#adjustflowstream) and
...
Emits a [CreateFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#createflowstream) and
...
Emits a {Transfer},
[CreateFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#createflowstream),
[DepositFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#depositflowstream) and
{MetadataUpdate} event. Notes:

- Refer to the notes in [create](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#create) and
  [deposit](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#deposit). Requirements:
- Refer to the requirements in [create](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#create)
  and [deposit](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#deposit).
...
Emits a {Transfer},
[DepositFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#depositflowstream),
[PauseFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#pauseflowstream) and
{MetadataUpdate} event. Notes:

- Refer to the notes in [deposit](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#deposit) and
  [pause](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#pause). Requirements:
- Refer to the requirements in [deposit](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#deposit)
  and [pause](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#pause).
...
Emits a [PauseFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#pauseflowstream) and
{MetadataUpdate} event. Notes:
...
Emits a {Transfer},
[RefundFromFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#refundfromflowstream) and
{MetadataUpdate} event. Requirements:
...
Emits a {Transfer},
[RefundFromFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#refundfromflowstream),
[PauseFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#pauseflowstream) and
{MetadataUpdate} event. Notes:

- Refer to the notes in [pause](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#pause).
  Requirements:
- Refer to the requirements in [refund](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#refund)
  and [pause](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#pause).
...
Emits a [RestartFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#restartflowstream)
...
- Refer to the notes in [restart](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#restart) and
  [deposit](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#deposit). Requirements:
- `amount` must be greater than zero.
- Refer to the requirements in
  [restart](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#restart).
...
[SetNativeToken](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#setnativetoken) event.
Requirements:
...
Emits a [SetNFTDescriptor](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#setnftdescriptor) and
...
Emits a [VoidFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#voidflowstream) and
{MetadataUpdate} event. Notes:
...
Emits a {Transfer},
[WithdrawFromFlowStream](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#withdrawfromflowstream)
and {MetadataUpdate} event. Notes:
...
- Refer to the notes in [withdraw](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#withdraw).
  Requirements:
- Refer to the requirements in
  [withdraw](/docs/reference/04-flow/contracts/interfaces/interface.ISablierFlow.md#withdraw).
