...
[Git Source](https://github.com/sablier-labs/evm-monorepo/blob/8b6823c019ff7556ac9ad24cbb5ac62821854d2f/src/Comptrollerable.sol)

**Inherits:** [IComptrollerable](/docs/reference/04-flow/contracts/interfaces/interface.IComptrollerable.md)

**Title:** Comptrollerable

See the documentation in [IComptrollerable](/docs/reference/04-flow/contracts/interfaces/interface.IComptrollerable.md).
