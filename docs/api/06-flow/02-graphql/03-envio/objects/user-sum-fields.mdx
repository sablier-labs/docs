...
#### [<code style={{ fontWeight: 'normal' }}>User_sum_fields.<b>chainId</b></code>](#)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>numeric</b></code>](/docs/api/flow/graphql/envio/scalars/numeric.mdx) <Badge class="badge badge--secondary " text="scalar"/>
