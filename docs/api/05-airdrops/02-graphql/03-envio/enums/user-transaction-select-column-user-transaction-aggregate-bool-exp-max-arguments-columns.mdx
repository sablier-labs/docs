---
id: user-transaction-select-column-user-transaction-aggregate-bool-exp-max-arguments-columns
title: UserTransaction_select_column_UserTransaction_aggregate_bool_exp_max_arguments_columns
---
...
#### [<code style={{ fontWeight: 'normal' }}>UserTransaction_select_column_UserTransaction_aggregate_bool_exp_max_arguments_columns.<b>fee</b></code>](#)
