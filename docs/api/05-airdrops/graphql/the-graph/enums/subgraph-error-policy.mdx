...
#### [<code style={{ fontWeight: 'normal' }}>\_SubgraphErrorPolicy\_.<b>allow</b></code>](#allow) \{#allow\}

Data will be returned even if the subgraph has indexing errors

#### [<code style={{ fontWeight: 'normal' }}>\_SubgraphErrorPolicy\_.<b>deny</b></code>](#deny) \{#deny\}
