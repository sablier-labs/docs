---
id: activity-aggregate-bool-exp
title: Activity_aggregate_bool_exp
---
...
#### [<code style={{ fontWeight: 'normal' }}>Activity_aggregate_bool_exp.<b>count</b></code>](#count)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>Activity_aggregate_bool_exp_count</b></code>](/docs/api/05-airdrops/graphql/envio/inputs/activity-aggregate-bool-exp-count.mdx) <Badge class="badge badge--secondary " text="input"/> \{#count\}
