---
id: action-aggregate-bool-exp
title: Action_aggregate_bool_exp
---
...
#### [<code style={{ fontWeight: 'normal' }}>Action_aggregate_bool_exp.<b>count</b></code>](#count)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>Action_aggregate_bool_exp_count</b></code>](/docs/api/05-airdrops/graphql/envio/inputs/action-aggregate-bool-exp-count.mdx) <Badge class="badge badge--secondary " text="input"/> \{#count\}
