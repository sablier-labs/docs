...
For the [first version](/apps/v1) of Sablier ([v1-app](v1-app.sablier.com), [v1-pay](v1-pay.sablier.com)) here are the
subgraphs powering those dashboards.
...
<LinkPreview
  ...
  icon="github"
  subtitle="@sablier-labs/v1-subgraph"
  title="Sablier V1 Subgraph"
/>
