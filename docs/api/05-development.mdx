...
[`indexers`](https://github.com/sablier-labs/indexers) repository.
...
To ensure Envio delivers the same data as The Graph's subgraphs, we've written differential tests. Check them
out inside the `apps/[...]/test/` folders.
