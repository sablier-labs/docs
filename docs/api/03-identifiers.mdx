...
Here's the full list of contract aliases, organized by protocol.
...
| LK2   | SablierLockup           | Lockup v3.0 |
| LK3   | SablierLockup           | Lockup v4.0 |
...
| FL3   | SablierFlow   | Flow v2.0 |
| FL4   | SablierFlow   | Flow v3.0 |

#### Airdrops

| Alias    | Contract Name                  | Release       |
| -------- | ------------------------------ | ------------- |
| MF_INST  | SablierFactoryMerkleInstant    | Airdrops v2.0 |
| MF_LL    | SablierFactoryMerkleLL         | Airdrops v2.0 |
| MF_LT    | SablierFactoryMerkleLT         | Airdrops v2.0 |
| MF_VCA   | SablierFactoryMerkleVCA        | Airdrops v2.0 |
| MF2_EXEC | SablierFactoryMerkleExecute    | Airdrops v3.0 |
| MF2_INST | SablierFactoryMerkleInstant    | Airdrops v3.0 |
| MF2_LL   | SablierFactoryMerkleLL         | Airdrops v3.0 |
| MF2_LT   | SablierFactoryMerkleLT         | Airdrops v3.0 |
| MF2_VCA  | SablierFactoryMerkleVCA        | Airdrops v3.0 |
