...
<ol type="A">
  <li>
    ...
    event issued by the Merkle factory
  </li>
...
Please read more in the dedicated route documentation within the
...
<ol type="A">
  <li>
    ...
    method and the Claim event issued by the Merkle contract instance
  </li>
  <li>Use the Sablier V2 [subgraphs / indexers](/api/overview) to query for that particular piece of information.</li>
</ol>
...
[`tokenURI`](/contracts/v2/reference/core/contract.SablierV2NFTDescriptor#tokenuri) method, which will return the SVG
