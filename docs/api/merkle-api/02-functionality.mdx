...
You can integrate the backend functionality using the official [endpoint](/api/merkle-api/intro) but we recommend
running it in a self-hosted environment for improved reliability (meaning you can fork and provide your own IPFS and
Pinata access keys).
