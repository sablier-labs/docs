---
id: user-transaction-select-column-user-transaction-aggregate-bool-exp-bool-and-arguments-columns
title: UserTransaction_select_column_UserTransaction_aggregate_bool_exp_bool_and_arguments_columns
---
...
#### [<code style={{ fontWeight: 'normal' }}>UserTransaction_select_column_UserTransaction_aggregate_bool_exp_bool_and_arguments_columns.<b>isAirdropClaim</b></code>](#)
