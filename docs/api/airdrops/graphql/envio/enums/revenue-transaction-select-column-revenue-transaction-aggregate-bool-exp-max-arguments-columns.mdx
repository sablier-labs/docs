---
id: revenue-transaction-select-column-revenue-transaction-aggregate-bool-exp-max-arguments-columns
title: RevenueTransaction_select_column_RevenueTransaction_aggregate_bool_exp_max_arguments_columns
---
...
#### [<code style={{ fontWeight: 'normal' }}>RevenueTransaction_select_column_RevenueTransaction_aggregate_bool_exp_max_arguments_columns.<b>amount</b></code>](#)
