---
id: user-transaction-select-column-user-transaction-aggregate-bool-exp-sum-arguments-columns
title: UserTransaction_select_column_UserTransaction_aggregate_bool_exp_sum_arguments_columns
---
...
#### [<code style={{ fontWeight: 'normal' }}>UserTransaction_select_column_UserTransaction_aggregate_bool_exp_sum_arguments_columns.<b>fee</b></code>](#)
