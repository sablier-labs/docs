...
#### [<code style={{ fontWeight: 'normal' }}>UserTransaction_aggregate_bool_exp_covar_samp_arguments.<b>X</b></code>](#)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>UserTransaction_select_column_UserTransaction_aggregate_bool_exp_covar_samp_arguments_columns!</b></code>](/docs/api/lockup/graphql/envio/enums/user-transaction-select-column-user-transaction-aggregate-bool-exp-covar-samp-arguments-columns.mdx) <Badge class="badge badge--secondary badge--non_null" text="non-null"/> <Badge class="badge badge--secondary " text="enum"/>
