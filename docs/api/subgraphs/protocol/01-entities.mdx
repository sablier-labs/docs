...
GraphQL entities defined by the Sablier subgraphs are meant to mirror the functionality exposed by our v2-core
...
[`schema.graphql`](https://github.com/sablier-labs/v2-subgraphs/blob/main/apps/protocol/schema.graphql) file is
