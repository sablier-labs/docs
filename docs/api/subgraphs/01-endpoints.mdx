...
[`@sablier/v2-core`](/reference/lockup/core/contract.SablierV2LockupLinear) contracts. It deals with core protocol
...
[`@sablier/v2-periphery`](/reference/lockup/periphery/contract.SablierV2BatchLockup) contracts, specifically
[`MerkleFactory`](/reference/lockup/periphery/contract.SablierV2MerkleLockupFactory). It deals with airstream-specific
