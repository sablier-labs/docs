...
These are the data subgraphs powering the [legacy version](/apps/legacy) of Sablier (deployed between 2019-2021).
...
| BSC       | sablier-bsc       | [Network][v1-network-bsc]       | [Studio][v1-studio-bsc]       |
