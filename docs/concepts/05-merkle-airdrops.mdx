...
the benefits of vested airdrops.
...
receive a fraction of the tokens every second through a Sablier stream.
...
years, but the recipients get the vested tokens only if a claim is made within that period of time.
...
your logo displayed in the claim page seen by the airdrop recipients.
...
vested at any time using the Sablier Interface at [app.sablier.com](https://app.sablier.com).
