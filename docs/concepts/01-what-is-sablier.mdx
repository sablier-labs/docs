...
- **The Sablier Protocol**: A collection of persistent, non-upgradeable smart contracts to facilitate streaming and
  distribution of ERC-20 tokens on Ethereum and other EVM blockchains.
...
Currently, Sablier consists of five separate systems:
...
- **Escrow**: enables peer-to-peer OTC token swaps
...
Bob and Escrow are deployed together as part of the same package.
