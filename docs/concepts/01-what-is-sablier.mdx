...
- **The Sablier Protocols**: A collection of persistent, non-upgradeable smart contracts to facilitate streaming of
  ERC-20 tokens on Ethereum and other EVM blockchains. The Sablier Protocols consist of Lockup and Flow.
...
- **The Sablier Labs**: The company that develops the Sablier Protocols, the Sablier Interface, and the documentation
...
Currently, it consists of two different protocols: **Lockup**, which facilitates vesting and airstreams, and **Flow**,
which facilitates payroll, grants etc. Both of these are licensed under BUSL-1.1. Both Lockup and Flow are open-source
and can be accessed on Sablier's [GitHub page](https://github.com/sablier-labs). Detailed technical reference for each
protocol can be found in the [Technical References](/reference/overview) section of this website.
...
- **v1.0 (latest)**: The first version of Flow Protocol, released in December 2024.

### Lockup

- **v1.2 (latest)**: The third version of Lockup Protocol, released in July 2024.
- **v1.1**: The second version of Lockup Protocol which was a minor upgrade, released in December 2023.
- **v1.0**: The first version of Lockup Protocol, released in July 2023.

### Legacy V1

- **v1.1**: Minor version upgrade, released in July 2021.
