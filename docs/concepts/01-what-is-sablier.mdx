...
- **The Sablier Protocols**: A collection of persistent, non-upgradeable smart contracts to facilitate streaming of
  ERC-20 assets on Ethereum and other EVM blockchains. The Sablier Protocols consist of Lockup and Flow.
...
[ERC-20](https://ethereum.org/en/developers/docs/standards/tokens/erc-20/) assets. The protocols employ a set of
...
protocol can be found in the [Technical References](/reference/lockup/overview) section of this website.
