...
- **v1.0.0 (latest)**: The first version of **The Flow Protocol**.

### Lockup

- **v1.2.0 (latest)**: The third version of **The Lockup Protocol**.
- **v1.1.2**: Minor version upgrade, released in December 2023.
- **v1.0.2**: The second version of **The Lockup Protocol**, released in July 2023.

### Legacy

- **v1.0.1**: Minor version upgrade, released in July 2021.
- **v1.0.0**: The first version of **The Lockup Protocol**, released in 2019.
