...
Comptroller has the following permissions on each chain where Escrow is deployed:

| Permission       | Function                                                                           |
| ---------------- | ---------------------------------------------------------------------------------- |
| Set Native Token | [`setNativeToken`](/reference/bob/contracts/contract.SablierEscrow#setnativetoken) |
| Set Trade Fee    | [`setTradeFee`](/reference/bob/contracts/contract.SablierEscrow#settradefee)       |
