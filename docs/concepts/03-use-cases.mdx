...
If you are interested in airdropping your token, check out the <Link href={links.app}>Sablier Interface</Link>, where
you can create multiple streams in a single transaction. Or, if you prefer to create the streams programmatically, check
out the docs on the [V2 Protocol](/contracts/v2/overview).
