...
Instant airdrops is the traditional way of running airdrops where there's no vesting period and tokens can instantly be claimed by
the recipients. Running an airdrop campaign can become very expensive if you are storing airdrop data on-chain, however.
...
This not only reduces cost of running an airdrop campaing but also inherits the security of the Sablier protocol.
...
All streams through Sablier are automated, which means, you don't have to send funds manually at the end of every
month.
