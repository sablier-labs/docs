...
However, the simple way of doing airdrops is flawed, because the majority of recipients typically sell their tokens
immediately after claiming them, and as a result the interest gathered by these airdrops is short-lived.

Simple airdrops fail to incentivize community members to think long-term. Recipients receive all of their tokens at
once, rather than over time. This is problematic, beacuse community members are the backbone of a crypto project, and
...
If you are insterested in airdropping your token, check out the <a href={links.app}>Sablier Interface</a>, where you can
