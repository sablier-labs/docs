...
Sablier features a protocol fee that the [protocol admin](/concepts/governance) can enable for specific ERC-20 assets.
...
A detailed explanation of flash loans can be found [here](/concepts/protocol/flash-loans).
