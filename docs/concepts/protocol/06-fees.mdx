...
There are two types of fees in Sablier: protocol fees and broker fees. Both are charged when a stream is created. In the
...
Just like with protocol fees, the broker fee is a percentage of the streamed amount, and it cannot be higher than 10%.
