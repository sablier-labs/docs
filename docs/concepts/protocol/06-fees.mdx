...
There are two types of fees in Sablier: protocol fees and broker fees.

## Protocol Fees

The protocol features a fee parameter that the [Protocol Admin](/concepts/governance) can enable for specific ERC-20
assets.
