...
Sablier protocol is entirely free to use. There is no protocol fee. However, external integrators who manage their own
UI may charge broker free in exchange for providing their services. Broker fee can only be charged when a stream is
...
To find how much each function costs, we've put together [benchmark reports](/contracts/v2/gas-benchmarks) for you.
