...
The contract that implements an Airstream Campaign is called `MerkleStream`. For those interested in the technical part,
[click here](/contracts/v2/reference/periphery/contract.SablierV2MerkleStreamerLL).

![](diagram-airstream-campaign.png)
