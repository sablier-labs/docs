...
Interesting in becoming a broker? Reach out on <a href={links.discord}>Discord</a>, or send an email to
...
Sablier V2 allows anyone to [flash loan](/docs/concepts/protocol/06-flash-loans.md) certain ERC-20 assets that have been
enabled by the protocol admin. It's important to note that no asset is available for flash loaning by default.

The flash fee is charged as a percentage of the principal, and is globally applied to all flash loans involving any
ERC-20 asset.
