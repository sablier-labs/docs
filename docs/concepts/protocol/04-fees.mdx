...
Sablier V2 features a protocol fee that the [protocol admin](/docs/concepts/05-admin) can enable for specific ERC-20
assets.
...
A detailed explanation of flash loans can be found [here](/docs/concepts/protocol/05-flash-loans.mdx).
