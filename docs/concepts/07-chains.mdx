...
import { Chains, totalChains } from "@site/src/components/organisms/Chains";
import { Links } from "@site/src/constants";

Sablier Protocol is live on {totalChains("mainnets")} mainnets and {totalChains("testnets")} testnets, although not all of these chains are supported by the
