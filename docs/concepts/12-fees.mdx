...
[Interface Fees](#Interface Fees), [Contract Fees](#Contract Fees), and [Gas Fees](#Gas Fee).
Each of these fees may go to a different party.
Below you can see a breakdown of how each fee is calculated and who receives it.
