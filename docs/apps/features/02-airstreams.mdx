...
The Sablier V2 interface can handle more than native streams. We developed a solution for distributing token streams to
...
For campaign admins, the interface enables a set of advanced settings like in-app visibility, in-app geographical
restrictions or (soon) campaign specific items like an eligibility criteria link.
