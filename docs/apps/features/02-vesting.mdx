...
The Sablier Interface will showcase [Lockup](/concepts/lockup/overview) streams under the Vesting tab.

:::important

In Q4 2024 the app has undergone a redesign. For past users, all streams created before this update will show up in the
Vesting page.
