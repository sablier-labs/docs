...
![Banner Airstreams](/banner/docs-banner-drops-airstreams.png)
...
![Banner Instant Drops](/banner/docs-banner-drops-instant.png)
...
|                                                         |
| ------------------------------------------------------- |
| ![Step 1](/screenshots/drops-form-1.png)                |
| ![Step 2](/screenshots/airstream-create-recipients.png) |

### Public source

You can distribute a large number of streams per campaign through our app. If you'd like to support Drops in your own UI
or have additional requirements, you can do so by using a self-hosted [Merkle service](/api/merkle-api/overview). Feel
free to get in touch for more details or premium support.
...
|                                       |
| ------------------------------------- |
| ![All](/screenshots/drops-search.png) |
...
the [v2-merkle-api](/api/merkle-api/overview) and the merkle subgraphs.
...
|                                         |
| --------------------------------------- |
| ![All](/screenshots/drops-settings.png) |
