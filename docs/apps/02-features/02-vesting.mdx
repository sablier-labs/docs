...
Vesting, everywhere. We support 11+ EVM chains and testnets where you can distribute tokens or get paid using Sablier.
...
Vesting is fully integrated with [Safe](https://safe.global). Start distributing tokens from the safety and comfort of
