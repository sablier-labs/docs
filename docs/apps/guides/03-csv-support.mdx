...
1. Access the create streams [gallery](https://app.sablier.com/gallery/group/) - make sure you're on the group tab (top
   right)
...
| ![Modal](/screenshots/create-group-template-modal.png)  |
...
**z** hours". (Each particle is of course optional)<br /><br/> **Timezones**: The dates and times extracted from the csv
are processed using the same timezone as the locales of the client's device.
...
|                                              |                                                         |
| -------------------------------------------- | ------------------------------------------------------- |
| ![Create](/screenshots/airstream-create.png) | ![Create](/screenshots/airstream-create-recipients.png) |
